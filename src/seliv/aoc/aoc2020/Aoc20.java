...
//    }
    ...
    public static void main(String[] args) {
        List<List<String>> in = InputParser.parseInput(IN_NOBODY);
        ...
        System.out.println(" = " + count.values().stream().distinct().collect(Collectors.toList()));
...
//            if (!Arrays.equals(bc, border.bc)) return false;
    ...
    public static String IN_Z = "Tile 3253:\n" +
            "###....#..\n" +
            ".#..##....\n" +
            "##.#.#.#.#\n" +
            "#.#.......\n" +
    ...
    public static String IN_NOBODY = "Tile 2053:\n" +
            "......#.#.\n" +
            "#....#....\n" +
            "#.#.......\n" +
            ".##.#..#.#\n" +
